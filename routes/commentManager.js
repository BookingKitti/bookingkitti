...
exports.add_hotel_comment=function(Hotel_ID,Scores,Account_ID,Comments){
...
exports.get_hotel_comment=function(Hotel_ID, callback){
  searchManager.query'select Scores and Comments from HotelComments',function(qerr,vals,fields){
      if(callback!=null)
